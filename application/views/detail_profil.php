...
<body>
	...
	<div class="content-wraper">
        ...
        margin-left: 30px;
        margin-right: 30px;">
			<h4><strong>DETAIL PROFIL</strong></h4>
			<table class="table">
				<tr>
					<th>Nama</th>
				...
				<tr>
					<th>Email</th>
					<td><?php echo $this->encryption->decrypt($this->session->userdata('email')); ?></td>
				</tr>
                <tr>
					<th>Username</th>
				...
				<tr>
					...
					<td><img src="<?php echo base_url(); ?>assets/foto/<?php echo $this->session->userdata('foto'); ?>"

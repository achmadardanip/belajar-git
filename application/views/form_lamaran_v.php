...
<head>
	<title>Aplikasi Lamaran Kerja</title>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-8" style="margin:0 auto; float:none;">
				<h3 align="center">Aplikasi Lamaran Kerja</h3>
				<br />
				<?php
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="nama_awal" class="form-control" placeholder="Masukkan nama awal"
									>
							</div>
							<div class="form-group">
                            ...
                            <div class="form-group">
								...
								<textarea name="deskripsi" class="form-control" placeholder="Masukkan deskripsi diri"
									></textarea>
							</div>
							<!-- <div class="form-group">
                        ...
                        <div class="form-group">
								<label>Hobi</label>
								<textarea name="hobi" class="form-control" placeholder="Masukkan hobi"
									></textarea>
							</div>
							<!-- <div class="form-group">
                            ...
                            <div class="form-group">
								...
								<input type="file" name="foto" class="form-control" accept=".png,.jgp, .jpeg">
							</div>
							<div class="form-group">
